            ...
            <div className="w-full max-w-[1600px] mx-auto">
                <div className="w-full px-6 md:px-0 flex flex-col md:flex-row items-center mb-12">
                    ...
                    <div className="w-full md:w-[60%] flex flex-col items-start justify-start">
                        <h1 className="text-[31px] md:text-[55px] lg:text-[67px] font-medium leading-tight text-black tracking-[-0.02em] font-inter bs-fade-up delay-100"
                            data-en="New Heart of Seoul" data-kr="New Heart of Seoul">New Heart of Seoul</h1>
                        <div id="desc-text"
                            className="font-inter w-full mt-6 md:mt-8 text-[14px] md:text-[17px] tracking-[-0.02em] font-extralight text-black leading-relaxed space-y-6 bs-fade-up delay-200">
