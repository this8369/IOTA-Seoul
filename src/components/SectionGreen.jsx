            ...
            <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1600px] mx-auto flex flex-col">
                ...
                <div className="w-full flex flex-col items-center mb-12 bs-fade-up">
                    ...
                    <div className="w-full max-w-[1400px] flex flex-col xl:flex-row justify-between items-center pt-8 pb-4">
                        ...
                        <div className="flex-1 text-[19px] md:text-[21px] font-medium text-gray-800 leading-[1.57] md:leading-[1.57] tracking-[-0.02em] break-keep text-center xl:text-left">
