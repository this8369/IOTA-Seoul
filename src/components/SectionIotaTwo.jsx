        ...
        <>
            <section className="section w-full h-auto bg-white pt-[50px] md:pt-[100px] pb-[100px] md:pb-[150px]" id="section-iotatwo">
                    ...
                    <div className="flex flex-col w-full bs-fade-up mt-24 md:mt-32">
                        ...
                        <div className="w-full max-w-[1300px] text-[14px] md:text-[17px] font-extralight text-gray-600 leading-[1.8] tracking-[-0.01em] font-inter mb-10 md:mb-14">
                            {lang === 'kr' ? (
                                ...
                                <div>
                                    <p className="mb-4">
                                        The rooftop garden of IOTA Two offers a lush, landscaped retreat surrounded by greenery. It provides a serene atmosphere where tenants can recharge as if they've stepped into the hills of Namsan—without ever leaving the office.
                                    </p>
                                    <p>
                    ...
                    <div className="flex flex-col w-full bs-fade-up mt-24 md:mt-32">
                        ...
                        <div className="w-full max-w-[1300px] text-[14px] md:text-[17px] font-extralight text-gray-600 leading-[1.8] tracking-[-0.01em] font-inter mb-10 md:mb-14">
                            {lang === 'kr' ? (
                                <div className="break-keep">
                                    <p className="mb-4">
                                        IOTA TWO의 오피스 메인 로비는 약 15미터의 층고와 전면유리 파사드를 통해 도심 한가운데에서도 개방감과 투명성을 극대화한 공간입니다.<br className="hidden md:block" />남산의 녹지와 시각적으로 연결되는 이 로비는 단순한 진입 공간을 넘어, 입주 기업과 방문객 모두에게 도시적 품격과 상징적 첫인상을 제공합니다.<br className="hidden md:block" />견고한 소재, 절제된 디테일, 그리고 자연광이 조화된 공간 구성은 IOTA TWO이 지향하는 '모던 헤리티지'의 정수를 보여줍니다.
                                    </p>
                                </div>
                            ) : (
                                <div>
                                    <p className="mb-4">
                                        The main office lobby of IOTA TWO features a soaring 15-meter ceiling and full-height glass façades, creating a sense of openness and transparency rarely achieved in the urban core.<br className="hidden md:block" />Visually connected to the greenery of Namsan, the lobby serves not only as an entryway but as a spatial statement of prestige and identity for its tenants and visitors.<br className="hidden md:block" />Defined by robust materials, refined detailing, and natural light, it embodies the architectural essence of modern heritage that defines IOTA Seoul.
                                    </p>
                                </div>
                            )}
                        </div>
                ...
                <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1600px] mx-auto flex flex-col items-start bs-fade-up mt-24 md:mt-32 mb-6 md:mb-8">
                    <h2 className="text-[28px] md:text-[40px] font-inter font-light text-black tracking-[-0.03em] leading-[1.2] break-keep">
                        Hotel EV Hall
                    </h2>
                </div>
