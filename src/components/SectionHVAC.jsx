        ...
        <section className="section w-full h-auto bg-white pt-[60px] pb-[100px]" id="section-hvac">
            <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1600px] mx-auto pt-12 bs-fade-up">
                ...
                <div className="w-full max-w-[1400px] mx-auto flex flex-col items-end bs-fade-up delay-300">
                    {lang === 'kr' ? (
                        <div className="w-full max-w-[700px] text-[17px] md:text-[19px] font-extralight text-[#222] leading-[1.75] tracking-[-0.02em] break-keep text-left">
                            <p className="mb-4">
                        ...
                        <div className="w-full max-w-[700px] text-[17px] md:text-[19px] font-extralight text-[#222] leading-[1.75] tracking-[-0.01em] font-inter text-left">
                            <p className="mb-4">
