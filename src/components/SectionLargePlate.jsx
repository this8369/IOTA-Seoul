                ...
                <div className="w-full max-w-[1200px] flex flex-col items-center">
                    ...
                    <div className="text-center flex flex-col items-center mb-10 md:mb-14">
                        ...
                        <h3 className="text-[28px] md:text-[40px] lg:text-[60px] font-bold text-[#1A2A3A] leading-tight tracking-tight mb-4 kr-target-text break-keep bs-fade-up delay-300"
                            ...
                            data-kr="The Most Spacious Floor Area in CBD<br/><span class='text-[22px] md:text-[32px] lg:text-[40px] mt-6 md:mt-8 block tracking-[-0.03em]' style='font-weight: bold;'>서울 주요 업무 권역에서 가장 넓은 오피스 바닥에서 협업과 혁신 촉진</span>">
