                    ...
                    <div className="w-full lg:w-[55%] flex flex-col">
                        {lang === 'kr' ? (
                            <div className="w-full flex flex-col items-start text-left">
                                ...
                                <div className="text-[17px] md:text-[19px] font-extralight text-[#222] leading-[1.75] tracking-[-0.02em] break-keep">
                                    <p className="mb-4">
                            ...
                            <div className="w-full flex flex-col items-start text-left">
                                <h2 className="text-[32px] md:text-[38px] lg:text-[46px] font-bold text-[#4a342a] tracking-[-0.03em] font-inter leading-[1.25] mb-8 break-keep">
                                    Korea's Largest Elevator with<br />Direct Vehicle & Heavy-Equipment Access
                                </h2>

                                <div className="text-[17px] md:text-[19px] font-extralight text-[#222] leading-[1.75] tracking-[-0.01em] font-inter">
                                    <p className="mb-4">
