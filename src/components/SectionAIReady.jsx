                        ...
                        <div className="w-full max-w-[1100px] mx-auto flex flex-col mt-[30px] shrink-0 text-left px-4 md:px-0">
                            {lang === 'kr' ? (
                                <>
                                    ...
                                    <div className="w-full text-[17px] md:text-[19px] font-extralight text-black leading-[1.6] tracking-[-0.02em] break-keep">
                                        <p className="mb-2">
                                ...
                                <>
                                    ...
                                    <div className="w-full text-[17px] md:text-[19px] font-extralight text-gray-800 leading-[1.6] tracking-[-0.01em] font-inter">
                                        <p className="mb-2">
