        ...
        <section className="section w-full h-auto bg-white pt-[50px] md:pt-[100px] pb-[100px]" id="section-namsan">
            <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1600px] mx-auto flex flex-col items-center">
                ...
                <div className="w-full mb-12 overflow-hidden bs-fade-up">
                    <img src="./img/namsan.jpg" alt="Namsan Autumn View" className="w-full h-auto object-cover" />
                </div>
                ...
                <div className="w-full flex flex-col md:flex-row justify-between items-start gap-8 md:gap-16 bs-fade-up delay-200">
                    ...
                    <div className="w-full md:w-[35%] shrink-0">
                        <h4 className="text-[18px] md:text-[20px] lg:text-[24px] font-bold text-[#6B3F3A] leading-snug tracking-[-0.02em] font-noto break-keep kr-target-text en-only-hide"
                    ...
                    <div className="w-full md:w-[65%] text-[13px] md:text-[14px] lg:text-[15px] text-[#111] leading-[1.7] tracking-[-0.01em] font-medium break-keep">
