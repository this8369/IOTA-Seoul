                ...
                <div className="w-full max-w-[1600px] mx-auto flex flex-col items-start bs-fade-up">
                    ...
                    {lang === 'kr' ? (
                        <>
                            ...
                            <div className="text-[17px] md:text-[19px] font-extralight text-stone-300 leading-[1.8] tracking-[-0.01em] break-keep max-w-[1200px]">
                                <p className="mb-4">
                        ...
                        <>
                            ...
                            <div className="text-[17px] md:text-[19px] font-extralight text-stone-300 leading-[1.8] tracking-[-0.01em] font-inter max-w-[1200px]">
                                <p className="mb-4">
                ...
                <div className="w-full max-w-[1600px] mx-auto flex flex-col gap-12 md:gap-[100px] mt-[60px] md:mt-[100px] bs-fade-up delay-200">
                    ...
                    <div className="w-full flex flex-col md:flex-row items-center md:items-start justify-between gap-8 md:gap-12 lg:gap-16">
                        ...
                        <div className="w-full md:w-[40%] flex flex-col items-start md:pt-[2%]">
                            ...
                            {lang === 'kr' ? (
                                <div className="text-[17px] md:text-[19px] font-extralight text-stone-300 leading-[1.8] tracking-[-0.01em] break-keep">
                                    <p className="mb-4">
                                ...
                                <div className="text-[17px] md:text-[19px] font-extralight text-stone-300 leading-[1.8] tracking-[-0.01em] font-inter">
                                    <p className="mb-4">
