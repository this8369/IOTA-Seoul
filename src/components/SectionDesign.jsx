        ...
        <section className="section w-full h-auto bg-black pt-[80px] md:pt-[120px] pb-[100px] md:pb-[150px]" id="section-design">
            <div className="w-[calc(100%-48px)] md:w-[calc(100%-100px)] max-w-[1600px] mx-auto flex flex-col items-center pt-12 bs-fade-up">
                ...
                <div className="text-center mb-16 px-4">
                    <h2 className="text-[52px] md:text-[70px] lg:text-[80px] font-extrabold text-[#e2d5c3] tracking-[-0.03em] leading-[1.57] font-inter mb-4 mt-[300px] md:mt-[600px]">
                ...
                <div className="w-full max-w-[1600px] mx-auto flex flex-col items-start bs-fade-up">
                    ...
                    {lang === 'kr' ? (
                        <>
                            ...
                            <div className="text-[17px] md:text-[19px] font-extralight text-stone-300 leading-[1.57] tracking-[-0.01em] break-keep max-w-[1200px]">
                                <p className="mb-4">
                        ...
                        <>
                            ...
                            <div className="text-[17px] md:text-[19px] font-extralight text-stone-300 leading-[1.57] tracking-[-0.01em] font-inter max-w-[1200px]">
                                <p className="mb-4">
                    ...
                    <div className="w-full flex flex-col md:flex-row items-center md:items-start justify-between gap-8 md:gap-12 lg:gap-16">
                        ...
                        <div className="w-full md:w-[40%] flex flex-col items-start md:pt-[2%]">
                            ...
                            {lang === 'kr' ? (
                                ...
                                <div className="text-[17px] md:text-[19px] font-extralight text-stone-300 leading-[1.57] tracking-[-0.01em] font-inter">
                                    <p className="mb-4">
