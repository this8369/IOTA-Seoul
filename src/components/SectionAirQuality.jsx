                ...
                <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center bs-fade-up delay-200">
                    ...
                    {lang === 'kr' ? (
                        <div className="w-full flex flex-col items-center">
                            ...
                            <div className="w-full text-[14px] md:text-[17px] font-extralight text-black leading-[1.7] tracking-[-0.02em] break-keep flex flex-col items-center">
                                <p className="mb-2">
                        ...
                        <div className="w-full flex flex-col items-center">
                            ...
                            <div className="w-full text-[14px] md:text-[17px] font-extralight text-gray-800 leading-[1.7] tracking-[-0.01em] font-inter flex flex-col items-center">
                                <p className="mb-2">
