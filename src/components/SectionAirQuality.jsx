...
export default function SectionAirQuality() {
    ...
    return (
        <section className="section w-full h-auto bg-white pt-12 pb-[100px] scroll-mt-[100px]" id="section-airquality">
                ...
                <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center text-center bs-fade-up delay-200">
                    ...
                    {lang === 'kr' ? (
                        <div className="w-full flex flex-col items-center">
                            ...
                            <div className="w-full text-[17px] md:text-[19px] font-semibold text-[#7b7b7d] font-inter leading-[1.4] tracking-[-0.01em] break-keep flex flex-col items-center">
                                <p className="mb-2">
                        ...
                        <div className="w-full flex flex-col items-center">
                            ...
                            <div className="w-full text-[17px] md:text-[19px] font-light text-black leading-[1.4] tracking-[-0.02em] font-inter flex flex-col items-center">
                                <p className="mb-2">
